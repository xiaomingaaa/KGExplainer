...
def construct_samples(args, triples, nentity, nrelation, negative_sample_size, true_head, true_tail, mode='tail-batch'):
    ...
    for i in range(len(triples)):
        ...
        total_samples.append([head, relation, tail, p_score])
        ...
        for i in range(len(negative_sample)):
            ...
            total_samples.append([negative_sample[i], relation, tail, score.numpy()])
        ...
        for i in range(len(negative_sample)):
            ...
            score = F.logsigmoid(score)
            total_samples.append([head, relation, negative_sample[i], score.numpy()])
